...
class Solver {
    ...
    reset(difficulty) {
        ...
        this.call = underscore__WEBPACK_IMPORTED_MODULE_1___default.a.sample(underscore__WEBPACK_IMPORTED_MODULE_1___default.a.range(0, 10), difficulty);
        this._turn = 1;
        this._candidateList = permutation(underscore__WEBPACK_IMPORTED_MODULE_1___default.a.range(0, 10), difficulty);
        this._outList = [];
        this._answerLog = [];
    }
    get candidateCount() {
...
var judge = (call, answer) => {
    var eat = 0;
    var bite = 0;
    underscore__WEBPACK_IMPORTED_MODULE_1___default.a.zip(call, answer).forEach(ary => {
        if (ary[0] === ary[1])
            eat += 1;
...
var permutation = (originalNumbers, length) => {
    var result = [];
    var loopLamb = (candidateTmp, numbers) => {
        numbers.forEach((x) => {
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('predict-area', {
    template: `
    <div id="predict-area">
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('log-area', {
    template: `
    <div id="log-area">
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('select-area', {
    template: `
    <div id="select-area">
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('select-buttons', {
    template: `
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('select-button', {
    template: `
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('confirm-button', {
    template: `
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('reset-button', {
    template: `
